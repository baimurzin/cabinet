...
//    List vacancies = new ArrayList<VacancyModel>() {
//        {
//            add(new VacancyModel(0, "Google", "middle Java Developer", 250000, 1));
//            add(new VacancyModel(1, "Yandex", "junior Java Developer", 150000, 1));
//            add(new VacancyModel(2, "FaceBook", "middle Java Developer", 240000, 1));
//            add(new VacancyModel(3, "Uber", "junior Java Developer", 180000, 1));
//        }
//    };
...
//    @RequestMapping("/career")              // need create a table for db
